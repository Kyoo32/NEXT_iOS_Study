...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.titlesArray = [NSArray arrayWithObjects:@"Getting started with WordPress", @"Catalonia changes ahead secession plans",  @"Hasbro may disappoint Star Wars fans", nil];
}
